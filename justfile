...
package version="1.0.1": build
    ...
    @echo '#!/usr/bin/env bash' > "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'set -e' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'PREFIX="$${HOME}/.local"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -d "$${PREFIX}/bin"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -m 755 aura "$${PREFIX}/bin/aura"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -d "$${PREFIX}/share/applications"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -m 644 io.github.antwny.aura.desktop "$${PREFIX}/share/applications/io.github.antwny.aura.desktop"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -d "$${PREFIX}/share/icons/hicolor/scalable/apps"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -m 644 io.github.antwny.aura.svg "$${PREFIX}/share/icons/hicolor/scalable/apps/io.github.antwny.aura.svg"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -d "$${PREFIX}/share/metainfo"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'install -m 644 io.github.antwny.aura.metainfo.xml "$${PREFIX}/share/metainfo/io.github.antwny.aura.metainfo.xml"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'command -v update-desktop-database >/dev/null 2>&1 && update-desktop-database "$${PREFIX}/share/applications" 2>/dev/null || true' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'command -v gtk-update-icon-cache >/dev/null 2>&1 && gtk-update-icon-cache -f -t "$${PREFIX}/share/icons/hicolor" 2>/dev/null || true' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo 'echo "Aura {{version}} installed successfully to ~/.local"' >> "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @chmod +x "target/package/aura-v{{version}}-x86_64-linux/install.sh"
    @echo '#!/usr/bin/env bash' > "target/package/aura-v{{version}}-x86_64-linux/uninstall.sh"
    @echo 'rm -f "$${HOME}/.local/bin/aura"' >> "target/package/aura-v{{version}}-x86_64-linux/uninstall.sh"
    @echo 'rm -f "$${HOME}/.local/share/applications/io.github.antwny.aura.desktop"' >> "target/package/aura-v{{version}}-x86_64-linux/uninstall.sh"
    @echo 'rm -f "$${HOME}/.local/share/icons/hicolor/scalable/apps/io.github.antwny.aura.svg"' >> "target/package/aura-v{{version}}-x86_64-linux/uninstall.sh"
    @echo 'rm -f "$${HOME}/.local/share/metainfo/io.github.antwny.aura.metainfo.xml"' >> "target/package/aura-v{{version}}-x86_64-linux/uninstall.sh"
    @echo 'echo "Aura uninstalled successfully."' >> "target/package/aura-v{{version}}-x86_64-linux/uninstall.sh"
